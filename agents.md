...
* **No ejecutado:** envío end-to-end real del formulario principal (crearía un lead de prueba en `cotizaciones_web` + correo al negocio) — pendiente de que Omar lo autorice o lo pruebe él.
