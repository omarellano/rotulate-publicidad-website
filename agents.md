...
* **Pendiente:** no hay fotos reales del producto (se usan swatches de color CSS, no fotografía); si Omar consigue fotos del Tach-Panel instalado/en almacén, mejorarían la página. Definir si se ofrece corte a medida con costo adicional real (la FAQ ya lo menciona como posibilidad genérica, sin precio).
