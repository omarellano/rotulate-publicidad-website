...
* **P0 restantes (abiertos):** P0-02 (instrumentación de Express — requiere adaptar el banner de consentimiento al CSS propio de Express), P0-04 (imágenes `new1/2/3.jpg` referenciadas en lonas pero ausentes del repo), P0-05 (precios Alucobond solo en JSON-LD) y P0-06 (mínimo facturable de lonas vs. meta «Sin mínimos») — dependen de decisiones comerciales de Omar o de trabajo mayor.
