...
* **Pendiente:** no se hizo commit ni deploy (no se pidió); falta decidir si estas fotos entran también a la galería de la home y con qué encuadre; purgar caché de Hostinger tras el próximo deploy que toque este sitio.
